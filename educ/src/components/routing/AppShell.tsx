...
import Sidebar from '@educ/components/layout/Sidebar'
import Navbar from '@educ/components/layout/Navbar'
import { AIAssistantWidget } from '@educ/features/demi/AIAssistantWidget'
import { RouteLoader } from '@educ/components/routing/ProtectedRoute'
import { pathToViewId, viewIdToPath } from '@educ/lib/routes/routeMap'
import { ErrorBoundary } from '@educ/components/shared/ErrorBoundary'
