      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="card p-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center p-3 bg-white/5 rounded-lg border border-border">
                <div>
                  <div className="text-sm font-bold text-white">PensiÃ³n Septiembre 2026</div>
          ...
          <div className="flex items-center gap-2 text-xs text-slate-400">
            ...
            TransacciÃ³n 100% encriptada. No almacenamos los datos de su tarjeta.
          </div>
        </div>
        ...
        <AnimatePresence mode="wait">
          {status === 'success' ? (
            ...
            <motion.div 
              ...
              className="card p-6"
            >
              <h3 className="text-lg font-bold text-white mb-4">MÃ©todo de Pago</h3>
 ...
 ${method === 'yape' ? 'bg-purple-500/20 border-purple-500/50 text-purple-400' : 'bg-white/5 border-border text-slate-400 hover:bg-white/10'}`}
              ...
              {method === 'card' && (
                <div className="space-y-4 mb-6">
                  <div>
                    <label className="text-xs text-slate-400 font-bold mb-1 block">NÃºmero de Tarjeta</label>
