...
const CORPORATE_PARTNERS = [
  { name: 'Globant', lookingFor: 'Pensamiento Algorítmico', icon: 'G', color: 'bg-green-600', candidates: 12 },
  { name: 'Deloitte', lookingFor: 'Liderazgo & Oratoria', icon: 'D', color: 'bg-black border border-white/20', candidates: 5 },
  { name: 'KPMG', lookingFor: 'Análisis Financiero', icon: 'K', color: 'bg-blue-800', candidates: 8 },
];

const CANDIDATES = [
  { id: 1, name: 'Estudiante #8842', match: 98, skills: ['Python', 'Lógica', 'Trabajo en Equipo'], year: '3ro Medio' },
  { id: 2, name: 'Estudiante #1092', match: 92, skills: ['React', 'Diseño UI', 'Empatía'], year: '4to Medio' },
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Conecta corporaciones con el talento temprano de tu institución basado en Digital Twins. Identidad anonimizada.
          </p>
        </div>
      </div>
