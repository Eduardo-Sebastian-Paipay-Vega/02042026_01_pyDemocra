...
export const AgenticSwarmOrchestrator = () => {
  ...
  useEffect(() => {
    const fakeEvents = [
      { msg: 'Detectada frustración en estudiante #482. Solicitando intervención.', agent: 'psych' },
      { msg: 'Buscando recurso kinestésico alternativo en base de datos.', agent: 'curator' },
      { msg: 'Recurso validado con 92% de efectividad histórica.', agent: 'auditor' },
      { msg: 'Notificando al docente sobre punto ciego en la lección actual.', agent: 'auditor' },
      { msg: 'Ajustando ruta dinámica del alumno y agendando tutoría.', agent: 'psych' },
    ];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Orquestación en tiempo real del enjambre de agentes autónomos.
          </p>
        </div>
