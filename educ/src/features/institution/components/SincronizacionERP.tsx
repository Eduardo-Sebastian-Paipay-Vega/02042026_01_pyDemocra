...
// RF-018: SincronizaciÃ³n ERP Contable
// RF-019: Exportador Multiformato de InformaciÃ³n
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-5xl mx-auto">
      ...
      <div>
        <h2 className="text-3xl font-bold text-white flex items-center gap-2">
          ...
          Hub de IntegraciÃ³n ERP & ExportaciÃ³n
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* SincronizaciÃ³n ERP (RF-018) */}
        <div className="card p-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-blue-500/10 p-2 rounded-lg">
              <RefreshCw className="text-blue-400 w-6 h-6" />
            </div>
            <h3 className="text-xl font-bold text-white">SincronizaciÃ³n API</h3>
          </div>
            ...
            <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-border">
              ...
              >
                {syncing ? (
                  ...
                  <><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Al dÃ­a</>
                ) : (
        ...
        <div className="card p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-bold text-white">Centro de ExportaciÃ³n</h3>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button className="p-4 bg-white/5 hover:bg-white/10 border border-border rounded-xl transition text-left group">
              ...
              <div className="text-sm font-bold text-white">Reporte de MatrÃ­culas</div>
            ...
            <button className="p-4 bg-white/5 hover:bg-white/10 border border-border rounded-xl transition text-left group">
              ...
              <div className="text-sm font-bold text-white">Logs de AuditorÃ­a</div>
