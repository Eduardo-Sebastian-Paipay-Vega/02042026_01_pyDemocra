      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Red de sensores distribuidos. PrevenciÃ³n de fallos predictiva mediante IA.
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between text-xs font-bold text-slate-400 mb-1">
                ...
                <span className="text-emerald-400">38Â°C</span>
              </div>
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-white">ClimatizaciÃ³n (HVAC)</h3>
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-amber-500/10 border border-amber-500/20 p-3 rounded-xl">
              ...
              <p className="text-xs text-amber-200/70">
                Filtro HEPA PabellÃ³n A (Piso 2) al 85% de saturaciÃ³n. Se requiere reemplazo en 4 dÃ­as para mantener eficiencia.
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-rose-500/10 border border-rose-500/20 p-3 rounded-xl">
              ...
              <p className="text-xs text-rose-200/70">
                Proyector Aula 3B (LÃ¡mpara al 98% de vida Ãºtil). Probabilidad de fallo en la prÃ³xima semana: 95%.
              </p>
            </div>
            <button className="w-full bg-rose-600 hover:bg-rose-500 text-white font-bold py-2 rounded-lg text-xs transition">
              Despachar TÃ©cnico Hoy
            </button>
          </div>
        </div>
