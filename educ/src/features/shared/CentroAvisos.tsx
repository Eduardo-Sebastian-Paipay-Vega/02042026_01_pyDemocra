...
const NOTIFICATIONS = [
  { id: 1, type: 'alert', title: 'Alerta de Lluvia', desc: 'Se suspende la clase de Ed. Física en el patio descubierto.', read: false, time: '10:00 AM' },
  { id: 2, type: 'circular', title: 'Circular #45: Matrícula 2027', desc: 'Proceso de admisión regular y cronograma oficial.', read: true, time: 'Ayer' },
  { id: 3, type: 'alert', title: 'Reunión Apoderados', desc: 'Recordatorio: Reunión hoy a las 19:00 hrs vía Meet.', read: true, time: 'Ayer' },
];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Buzón central de avisos, alertas y circulares firmadas.
          </p>
        </div>
        <div className="flex gap-2 card p-1 rounded-xl">
          ...
          >
            No Leídos <div className="w-2 h-2 rounded-full bg-blue-500" />
          </button>
        </div>
      </div>
            ...
            <div className="card p-8 h-full">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <div className="text-xs text-slate-500">Emitido por: Dirección General</div>
                </div>
              ...
              {NOTIFICATIONS.find(n => n.id === activeNote)?.type === 'circular' && (
                <div className="bg-indigo-500/10 border border-indigo-500/20 p-5 rounded-xl mb-6 relative overflow-hidden">
                  ...
                  <ul className="list-disc list-inside text-indigo-200/80 text-sm space-y-1 relative z-10">
                    <li>El proceso de matrícula inicia el 15 de Octubre.</li>
                    <li>Descuento del 10% para hermanos matriculados juntos.</li>
                    <li>Documentación debe subirse al portal antes del 30 de Octubre.</li>
                  </ul>
                </div>
              )}
