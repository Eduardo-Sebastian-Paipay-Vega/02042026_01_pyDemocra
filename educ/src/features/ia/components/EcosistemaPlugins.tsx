...
const PLUGINS = [
  { id: 1, name: 'Google Workspace Sync', vendor: 'Oficial', status: 'installed', type: 'Core', desc: 'SincronizaciÃ³n bidireccional con Google Classroom y Drive.' },
  { id: 2, name: 'SAP ERP Connector', vendor: 'Enterprise', status: 'installed', type: 'Finanzas', desc: 'ExportaciÃ³n de asientos contables a SAP B1 en tiempo real.' },
  { id: 3, name: 'Zoom Live Classes', vendor: 'Oficial', status: 'available', type: 'Video', desc: 'GeneraciÃ³n automÃ¡tica de links de Zoom para cada lecciÃ³n.' },
  { id: 4, name: 'Stripe Payments', vendor: 'Oficial', status: 'installed', type: 'Core', desc: 'Procesamiento de pagos de matrÃ­culas y pensiones.' },
  { id: 5, name: 'Turnitin Anti-Plagio', vendor: 'Terceros', status: 'update', type: 'AcadÃ©mico', desc: 'AnÃ¡lisis de similitud en entregables y ensayos.' },
];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Arquitectura API-First: Instala mÃ³dulos de terceros o gestiona Webhooks.
          </p>
        </div>
          ...
          {PLUGINS.map(plugin => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border">
                <span className="text-xs text-slate-500">{plugin.vendor} â€¢ {plugin.type}</span>
