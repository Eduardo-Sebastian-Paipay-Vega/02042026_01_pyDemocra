...
// RF-045: Clanes P2P y GamificaciÃ³n Social

const MEMBERS = [
  { name: 'TÃº', role: 'Estratega', xp: 4500, avatar: 'T' },
  { name: 'LucÃ­a P.', role: 'Analista', xp: 4200, avatar: 'L' },
  { name: 'Marcos R.', role: 'Creativo', xp: 3900, avatar: 'M' },
  { name: 'SofÃ­a T.', role: 'Ejecutor', xp: 3850, avatar: 'S' },
];
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                <span className="bg-orange-500 text-white text-xs font-bold px-2 py-1 rounded-md">DivisiÃ³n Oro</span>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="card p-5 hover:border-orange-500/50 transition cursor-pointer">
              ...
              <p className="text-sm text-slate-400 mb-4">Resuelvan 10 problemas de lÃ³gica algorÃ­tmica en equipo sin fallos crÃ­ticos.</p>
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="card p-5 hover:border-blue-500/50 transition cursor-pointer">
              ...
              <h4 className="font-bold text-white mb-2">Dominio HistÃ³rico</h4>
              <p className="text-sm text-slate-400 mb-4">Todos los miembros deben completar el mÃ³dulo de RevoluciÃ³n Industrial.</p>
