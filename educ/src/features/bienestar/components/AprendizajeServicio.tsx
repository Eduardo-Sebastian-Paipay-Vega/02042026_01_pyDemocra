    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="card overflow-hidden group hover:border-emerald-500/50 transition duration-300">
          ...
          <div className="p-6">
            <h3 className="text-lg font-bold text-white mb-2">ReforestaciÃ³n Valle Sur</h3>
            <p className="text-sm text-slate-400 mb-4 line-clamp-2">
              Ãšnete a la brigada ecolÃ³gica del colegio para plantar 500 Ã¡rboles nativos en la zona deforestada del valle.
            </p>
        ...
        <div className="card overflow-hidden group hover:border-sky-500/50 transition duration-300">
          ...
          <div className="p-6">
            <h3 className="text-lg font-bold text-white mb-2">TutorÃ­a a Primaria (MatemÃ¡ticas)</h3>
            <p className="text-sm text-slate-400 mb-4 line-clamp-2">
              Apoya a los alumnos de 4to grado con sus tareas de matemÃ¡ticas en horario extracurricular.
            </p>
            <div className="flex items-center gap-2 text-xs text-slate-500 font-bold mb-6">
            ...
            <button className="w-full bg-white/5 border border-border text-slate-300 cursor-not-allowed font-bold py-3 rounded-xl transition flex items-center justify-center gap-2">
              <CheckCircle2 className="w-4 h-4" /> Ya estÃ¡s inscrito
            </button>
          </div>
        </div>
