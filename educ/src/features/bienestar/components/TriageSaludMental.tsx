      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Tu espacio confidencial. Nadie verÃ¡ esto excepto tu orientador.
          </p>
        </div>
        <button 
        ...
        {!submitted ? (
          ...
          >
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-6">Nivel de EnergÃ­a / EstrÃ©s</h3>
                <div className="flex justify-between px-2 mb-2 text-xs font-bold text-slate-400">
                  <span>Agotado</span>
                  <span>Equilibrado</span>
                  <span>Con mucha energÃ­a</span>
                </div>
                <input 
                  type="range" 
                  min="1" max="5" 
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-4">Â¿Quieres contarme algo mÃ¡s? (Opcional)</h3>
                <textarea 
                  rows={4}
                  ...
                  placeholder="Puedes escribir aquÃ­ lo que sientas..."
                />
              </div>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Â¡Check-in Registrado!</h3>
            <p className="text-emerald-200/70 max-w-md mx-auto">
              Gracias por compartir cÃ³mo te sientes. Recuerda que el equipo de orientaciÃ³n estÃ¡ siempre aquÃ­ para ti.
            </p>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      {showPanic && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white mb-4">No estÃ¡s solo.</h3>
            <p className="text-slate-300 mb-8">
              Estamos enviando una notificaciÃ³n prioritaria y confidencial a tu orientador. Se pondrÃ¡n en contacto contigo hoy mismo.
            </p>
