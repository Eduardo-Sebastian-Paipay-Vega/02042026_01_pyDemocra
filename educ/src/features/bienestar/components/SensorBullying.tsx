...
// RF-040: Sensor Multimodal de PrevenciÃ³n de Bullying
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-white flex items-center gap-2">
            ...
            PrevenciÃ³n Multimodal de Conflictos
          </h2>
          <p className="text-muted-foreground mt-1">
            EscÃ¡ner pasivo (NLP) y anÃ¡lisis de grafos sociales para intervenciÃ³n temprana.
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-rose-950/20 border border-rose-500/20 rounded-2xl p-5 relative overflow-hidden group">
            ...
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-rose-200/60">Detectado hace 5 min â€¢ Grupo "Proyecto Historia"</p>
                </div>
              </div>
            ...
            <div className="bg-black/40 border border-border p-4 rounded-xl mt-4">
              <p className="text-sm text-slate-300 italic mb-2">"...eres un inÃºtil, sÃ¡quenlo del grupo, no aporta nada..."</p>
          ...
          <div className="bg-orange-950/20 border border-orange-500/20 rounded-2xl p-5 relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-white text-lg">CaÃ­da abrupta de participaciÃ³n</h4>
                  <p className="text-sm text-orange-200/60">AnÃ¡lisis Ãºltimos 7 dÃ­as â€¢ Estudiante #2045</p>
                </div>
              </div>
              <span className="bg-orange-500 text-white text-xs font-bold px-2 py-1 rounded">Riesgo 60%</span>
            </div>
            <div className="bg-black/40 border border-border p-4 rounded-xl mt-4">
              <p className="text-sm text-slate-300 mb-2">El estudiante dejÃ³ de interactuar en foros y ha bajado su tiempo de lectura en un 80%. Posible indicador temprano de exclusiÃ³n o depresiÃ³n leve.</p>
            </div>
            <div className="mt-4 flex gap-2">
              <button className="bg-white/5 hover:bg-white/10 text-white text-sm font-bold px-4 py-2 rounded-lg transition border border-border">
                Agendar TutorÃ­a
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="card p-6">
            <div className="text-center mb-6">
              ...
              <div className="text-sm text-slate-400 mt-1">Ãndice de Convivencia Saludable</div>
            </div>
            ...
            <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
              <p className="text-xs text-blue-200">
                El modelo NLP estÃ¡ entrenado en lenguaje juvenil local para diferenciar bromas amistosas de ciberacoso real, protegiendo la privacidad de los usuarios (Zero-Knowledge).
              </p>
            </div>
          </div>
        </div>
