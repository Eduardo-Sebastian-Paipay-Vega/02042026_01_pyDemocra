...
// RF-007: Misiones, DesafÃ­os y Retos Semanales
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-black/50 rounded-lg flex items-center justify-center">
                        {level === 1 ? 'ðŸŽ' : <Lock className="w-4 h-4 text-slate-600" />}
                      </div>
                      <div>
                        <div className={`text-sm font-bold ${level === 1 ? 'text-amber-400' : 'text-slate-500'}`}>Cofre Ã‰pico</div>
