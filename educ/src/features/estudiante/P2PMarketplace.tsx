...
// RF-028: Mercado Inter-Institucional de Tutorías P2P

const MOCK_TUTORS = [
  { id: 1, name: 'Valeria S.', subject: 'Cálculo Avanzado', rating: 4.9, reviews: 34, xpLevel: 85, cost: 50, avatar: 'V', online: true },
  { id: 2, name: 'Diego R.', subject: 'Física Cuántica', rating: 4.7, reviews: 12, xpLevel: 72, cost: 40, avatar: 'D', online: false },
  { id: 3, name: 'Camila T.', subject: 'Programación en Python', rating: 5.0, reviews: 89, xpLevel: 98, cost: 75, avatar: 'C', online: true },
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Conecta con los mejores estudiantes de la red. Paga tus mentorías 1:1 usando EduTokens.
          </p>
        </div>
      ...
      <div className="flex gap-4 mb-6">
        <div className="relative flex-1">
          ...
          <input 
            type="text" 
            placeholder="Buscar materia (ej: Álgebra, React, Historia)..." 
