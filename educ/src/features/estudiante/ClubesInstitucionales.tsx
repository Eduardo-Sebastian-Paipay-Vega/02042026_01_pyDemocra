      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Explora, únete y gestiona tus actividades extracurriculares.
          </p>
        </div>
      </div>
          ...
          <div className="card p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 border border-border p-4 rounded-2xl cursor-pointer hover:bg-white/10 transition">
                <div className="font-bold text-slate-300">Robótica Avanzada</div>
          ...
          <div className="card p-8">
            ...
            <div className="flex justify-between items-start mb-8 pb-8 border-b border-border">
              <div>
                ...
                <p className="text-slate-400 max-w-xl">Preparación para el torneo regional. Discusión de políticas internacionales y oratoria.</p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="bg-white/5 border border-border rounded-2xl p-6">
                <h4 className="font-bold text-white mb-4 flex items-center gap-2">
                  <Calendar className="w-5 h-5 text-sky-400" /> Próximas Reuniones
                </h4>
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-bold text-slate-300 text-sm">Simulacro de Comité OMS</div>
              ...
              <div className="bg-white/5 border border-border rounded-2xl p-6">
                ...
                <div className="space-y-3 mb-4 h-32 overflow-hidden relative">
                  ...
                  <div className="text-sm">
                    <span className="font-bold text-indigo-400">Ana (Presidenta):</span> <span className="text-slate-300">Chicos, recuerden leer el dossier de resoluciones para mañana.</span>
                  </div>
                  <div className="text-sm">
                    <span className="font-bold text-sky-400">Marcos:</span> <span className="text-slate-300">¿Alguien tiene el enlace al documento de economía?</span>
                  </div>
                </div>
