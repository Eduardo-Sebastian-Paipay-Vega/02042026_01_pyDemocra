...
const mockBadges = [
  { id: 1, name: 'Pionero', description: 'Completó el Módulo 1 el primer día', icon: <Medal className="w-8 h-8 text-yellow-400" />, color: 'from-yellow-900/50 to-yellow-600/20', border: 'border-yellow-500/30' },
  { id: 2, name: 'Imparable', description: 'Racha de 7 días de estudio continuo', icon: <Zap className="w-8 h-8 text-blue-400" />, color: 'from-blue-900/50 to-blue-600/20', border: 'border-blue-500/30' },
  ...
  { id: 4, name: 'Guardián', description: 'Ayudó a 5 compañeros en el foro', icon: <Shield className="w-8 h-8 text-green-400" />, color: 'from-green-900/50 to-green-600/20', border: 'border-green-500/30' },
  { id: 5, name: 'Precisión', description: 'Cero errores en código de prueba', icon: <Target className="w-8 h-8 text-red-400" />, color: 'from-red-900/50 to-red-600/20', border: 'border-red-500/30' },
];
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Colección de insignias obtenidas (RF-005)</p>
        </div>
