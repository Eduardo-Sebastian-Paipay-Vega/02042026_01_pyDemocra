...
// RF-003: Reproducción Multimedia HLS
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl mx-auto">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Módulo 2: Conceptos Fundamentales</p>
        </div>
      </div>
      ...
      <div className="p-4 bg-card/30 backdrop-blur-md rounded-xl border border-border">
        <h3 className="font-semibold text-white mb-2">Transcripción Automática (IA)</h3>
        <p className="text-muted-foreground text-sm leading-relaxed">
          <span className="text-primary font-medium">12:00</span> - "Como hemos visto, la infraestructura basada en grafos permite una adaptabilidad instantánea. Esto no es solo teoría, es la aplicación directa de..."
        </p>
      </div>
    </div>
  );
