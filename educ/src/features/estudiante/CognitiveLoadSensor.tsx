      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Monitoreo biométrico simulado de carga mental, estrés visual y rendimiento.
          </p>
        </div>
        <div className="flex items-center gap-4 card px-4 py-2 rounded-xl">
          ...
          <span className="font-bold text-purple-400 bg-purple-500/10 px-2 py-1 rounded">Visual-Espacial / Kinestésico</span>
        </div>
      </div>
          ...
          {requiresBreak ? (
            <div className="space-y-4">
              <p className="text-sm text-red-200 bg-red-500/10 p-3 rounded-lg border border-red-500/20">
                Tu carga cognitiva está bloqueando la asimilación a largo plazo. La IA recomienda una pausa activa.
              </p>
            ...
            <div className="space-y-4">
              <p className="text-sm text-blue-200 bg-blue-500/10 p-3 rounded-lg border border-blue-500/20">
                Condiciones óptimas. Tu retención de memoria de trabajo está en su pico.
              </p>
