...
export function TestimonialCard({ quote, name, role }: TestimonialCardProps) {
  ...
  return (
    <GlassCard hover className="flex flex-col justify-between p-8">
      ...
      <svg
        aria-hidden="true"
        className="mb-5 h-7 w-7 text-[#4A7BA7]/50 flex-shrink-0"
        fill="currentColor"
        viewBox="0 0 24 24"
      >
      ...
      <div className="mt-7 flex items-center gap-3 border-t border-white/[0.06] pt-6">
        ...
        <div className="min-w-0">
          ...
          <span className="mt-0.5 inline-block rounded-full bg-[#4A7BA7]/12 px-2.5 py-[3px] text-[11px] font-medium text-[#4A7BA7]">
            {role}
          </span>
        </div>
      </div>
