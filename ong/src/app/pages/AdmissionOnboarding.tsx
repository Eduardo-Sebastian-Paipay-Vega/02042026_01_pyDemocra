    ...
    <div className="min-h-screen bg-[#100F0D] p-6 font-sans text-[#F9F7F3] space-y-8">
      ...
      <section className="pt-6 border-t border-[#26231F]">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
          ...
          <div
            className="space-y-3 rounded-2xl px-4 py-4 bg-[#171512] border border-[#26231F]"
          >
            <div className="grid gap-3 md:grid-cols-[minmax(0,320px)_1fr]">
              ...
              {selectedRequest ? (
                <div className="grid gap-3 md:grid-cols-4">
                  ...
                  />
                  <DetailField label="Registro" value={new Date(selectedRequest.submittedAt).toLocaleDateString()} />
                </div>
              ) : (
                <p className="text-[12px]" style={{ color: "var(--t-text-dim)" }}>
          ...
          {selectedRequest && selectedRequest.resolvedVolunteerSource === "email" && (
            <div
              className="rounded-2xl px-4 py-3 text-[12px] bg-[#171512] border border-[#26231F]"
            >
