...
import { ProtectedRoute, NotFoundScreen, RouteLoader } from '@/components/routing/ProtectedRoute'
...
const DemiPage          = lazy(() => import('@/features/demi/DemiPage'))

// Dashboards (role-flavored landing pages)
const DashboardDirector    = lazy(() => import('@/features/director/DashboardDirector'))
const DashboardDocente     = lazy(() => import('@/features/docente/DashboardDocente'))
const DashboardCoordinador = lazy(() => import('@/features/coordinador/DashboardCoordinador'))
const DashboardPadres      = lazy(() => import('@/features/padres/DashboardPadres'))
const DashboardCFO         = lazy(() => import('@/features/finanzas/DashboardCFO'))
const DashboardEstudiante  = lazy(() => import('@/features/estudiante/DashboardEstudiante'))

// Educa domain
const CurriculumBuilder    = lazy(() => import('@/features/educa/CurriculumBuilder'))
const BancoItemesLLM       = lazy(() => import('@/features/educa/BancoItemesLLM'))
const EngineCATIRT         = lazy(() => import('@/features/educa/EngineCATIRT'))
const ProctoringIA         = lazy(() => import('@/features/educa/ProctoringIA'))
const PeerReviewCiego      = lazy(() => import('@/features/educa/PeerReviewCiego'))
const EvaluacionPsicotecnica = lazy(() => import('@/features/educa/EvaluacionPsicotecnica'))
const DynamicPathingMap    = lazy(() => import('@/features/educa/DynamicPathingMap'))
const DigitalTwinView      = lazy(() => import('@/features/educa/DigitalTwinView'))
const CognitiveLoadSensor  = lazy(() => import('@/features/educa/CognitiveLoadSensor'))
const LeaderboardXP        = lazy(() => import('@/features/educa/LeaderboardXP'))
const BadgesGallery        = lazy(() => import('@/features/educa/BadgesGallery'))
const MisionesRetos        = lazy(() => import('@/features/educa/MisionesRetos'))
const Lab3DWebGL           = lazy(() => import('@/features/educa/Lab3DWebGL'))
const VideoPlayerHLS       = lazy(() => import('@/features/educa/VideoPlayerHLS'))
const ResourceRepository   = lazy(() => import('@/features/educa/ResourceRepository'))
const AsistenciaQR         = lazy(() => import('@/features/educa/AsistenciaQR'))

// Finanzas domain
const DashboardCFOComp     = lazy(() => import('@/features/finanzas/components/DashboardCFO'))
const PasarelaPagos        = lazy(() => import('@/features/finanzas/components/PasarelaPagos'))
const TokenEconomy         = lazy(() => import('@/features/finanzas/components/TokenEconomyDashboard'))

// EWS domain
const EWSDetailView        = lazy(() => import('@/features/ews/components/EWSDetailView'))
const BehavioralAnalytics  = lazy(() => import('@/features/ews/components/BehavioralAnalytics'))

// Comunicacion domain
const ChatAcademico        = lazy(() => import('@/features/comunicacion/ChatAcademico'))
const CentroAvisos         = lazy(() => import('@/features/comunicacion/CentroAvisos'))
const RedSocialSegura      = lazy(() => import('@/features/comunicacion/RedSocialSegura'))
const ParentLiveStream     = lazy(() => import('@/features/comunicacion/ParentLiveStream'))

// Institution domain
const GestorEspacios       = lazy(() => import('@/features/institution/components/GestorEspacios'))
const HorariosGeneticos    = lazy(() => import('@/features/institution/components/HorariosGeneticos'))
const NominaInteligente    = lazy(() => import('@/features/institution/components/NominaInteligente'))
const MantenimientoPred    = lazy(() => import('@/features/institution/components/MantenimientoPredictivo'))
const ScoringBecasIA       = lazy(() => import('@/features/institution/components/ScoringBecasIA'))
const ProtocolosCrisis     = lazy(() => import('@/features/institution/components/ProtocolosCrisis'))
const ObservatorioClima    = lazy(() => import('@/features/institution/components/ObservatorioClima'))
const CentroPrivacidadGDPR = lazy(() => import('@/features/institution/components/CentroPrivacidadGDPR'))
const SincronizacionERP    = lazy(() => import('@/features/institution/components/SincronizacionERP'))

// IA domain
const AgenticSwarm         = lazy(() => import('@/features/ia/components/AgenticSwarmOrchestrator'))
const KnowledgeGraphView   = lazy(() => import('@/features/ia/components/KnowledgeGraphView'))
const FederatedLearning    = lazy(() => import('@/features/ia/components/FederatedLearningConfig'))
const EcosistemaPlugins    = lazy(() => import('@/features/ia/components/EcosistemaPlugins'))

// Bienestar domain
const TriageSaludMental    = lazy(() => import('@/features/bienestar/components/TriageSaludMental'))
const SensorBullying       = lazy(() => import('@/features/bienestar/components/SensorBullying'))
const ClanesP2P            = lazy(() => import('@/features/bienestar/components/ClanesP2P'))
const ClubesInstitucionales = lazy(() => import('@/features/bienestar/components/ClubesInstitucionales'))
const PlanInclusionPIE     = lazy(() => import('@/features/bienestar/components/PlanInclusionPIE'))
const AprendizajeServicio  = lazy(() => import('@/features/bienestar/components/AprendizajeServicio'))
const P2PMarketplace       = lazy(() => import('@/features/bienestar/components/P2PMarketplace'))

// Identidad domain
const SovereignIdentity    = lazy(() => import('@/features/identidad/components/SovereignIdentityWallet'))
const B2BTalentMarketplace = lazy(() => import('@/features/identidad/components/B2BTalentMarketplace'))
