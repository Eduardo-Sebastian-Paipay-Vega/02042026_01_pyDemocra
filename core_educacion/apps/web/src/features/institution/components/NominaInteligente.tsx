...
// RF-056: NÃ³mina Docente Inteligente
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-white flex items-center gap-2">
            ...
            NÃ³mina Docente Inteligente
          </h2>
          <p className="text-muted-foreground mt-1">
            CÃ¡lculo de horas lectivas, bonos gamificados e integraciÃ³n ERP.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="card p-6">
            <h3 className="text-sm font-bold text-slate-400 mb-6 uppercase tracking-wider">ProyecciÃ³n NÃ³mina</h3>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-emerald-400 font-bold">Bonos (GamificaciÃ³n)</span>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 border border-border rounded-2xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">MatemÃ¡ticas - Nivel Secundario</div>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <div className="text-[10px] text-emerald-400 uppercase font-bold">Bono MentorÃ­a</div>
              ...
              <div className="bg-white/5 border border-border rounded-2xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-bold text-white">Prof. MarÃ­a Vargas</div>
                    <div className="text-xs text-slate-400">Ciencias / RobÃ³tica</div>
                  </div>
                </div>
