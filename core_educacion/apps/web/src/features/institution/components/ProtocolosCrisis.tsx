...
// RF-061: Protocolos de Crisis y EvacuaciÃ³n (Centro de Comando)
...
export const ProtocolosCrisis = () => {
  ...
  const protocols = [
    ...
    { id: 'lockdown', title: 'Lockdown (IntrusiÃ³n)', color: 'rose', icon: Lock },
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Despliegue tÃ¡ctico de protocolos de emergencia (IoT + Push + RFID).
          </p>
        </div>
        {activeProtocol && (
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-border rounded-2xl p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-400">Todas las puertas exteriores bloqueadas automÃ¡ticamente.</div>
                      </div>
                    </div>
                  ...
                  <div className="bg-white/5 border border-border rounded-2xl p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="font-bold text-white">NotificaciÃ³n Push (App Padres)</div>
                        <div className="text-xs text-slate-400">Aviso enviado a 1,240 dispositivos mÃ³viles.</div>
                      </div>
                    </div>
                  ...
                  <div className="bg-white/5 border border-border rounded-2xl p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-400">Esperando confirmaciÃ³n de zonas seguras vÃ­a Smartwatch.</div>
                      </div>
                    </div>
