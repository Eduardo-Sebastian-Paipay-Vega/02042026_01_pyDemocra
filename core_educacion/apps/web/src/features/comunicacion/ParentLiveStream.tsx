...
const FEED_EVENTS = [
  { id: 1, type: 'achievement', title: 'MÃ³dulo Completado', desc: 'Lucas completÃ³ "Estructuras de Datos" con 95% de precisiÃ³n.', time: 'Hace 10 min', icon: <Sparkles className="w-5 h-5 text-yellow-500" /> },
  { id: 2, type: 'mood', title: 'Estado de Ãnimo Ã“ptimo', desc: 'El sensor biomÃ©trico reporta un estado de "Flow" durante la clase de MatemÃ¡ticas.', time: 'Hace 2 horas', icon: <Heart className="w-5 h-5 text-pink-500" /> },
  { id: 3, type: 'alert', title: 'IntervenciÃ³n EWS', desc: 'Demi AI detectÃ³ fatiga visual. Se sugiriÃ³ y tomÃ³ una pausa activa de 15 min.', time: 'Ayer, 14:30', icon: <Activity className="w-5 h-5 text-blue-500" /> },
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            TransmisiÃ³n en tiempo real del progreso acadÃ©mico y estado cognitivo de tu hijo.
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-xs mb-1">
                  <span className="text-slate-300">Nivel de EnergÃ­a</span>
                  <span className="text-green-400 font-bold">Ã“ptimo</span>
                </div>
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  <span className="text-slate-300">Carga AcadÃ©mica</span>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-200/70 mt-1">
                  Lucas ha mostrado gran interÃ©s en RobÃ³tica hoy. Sugerimos preguntarle sobre su proyecto durante la cena para reforzar su engagement positivo.
                </p>
              </div>
            </div>
          </div>
