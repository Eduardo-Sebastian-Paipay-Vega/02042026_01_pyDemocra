...
export const RedSocialSegura = () => {
  ...
  const handleTyping = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    setPost(text);
    // SimulaciÃ³n de Sensor de Bullying NLP
          ...
          <div className="flex-1 space-y-3">
            ...
            {warning && (
              <div className="bg-rose-500/10 text-rose-400 p-2 rounded-lg text-xs font-bold flex items-center gap-2">
                ...
                El analizador detectÃ³ lenguaje inapropiado. Por favor, mantÃ©n el respeto.
              </div>
            )}
      ...
      <div className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="font-bold text-white">MarÃ­a Vargas</span>
                <span className="text-xs text-sky-400 bg-sky-500/10 px-2 py-0.5 rounded-full">Club de RobÃ³tica</span>
                <span className="text-xs text-slate-500">hace 2h</span>
              </div>
              <p className="text-slate-300 text-sm leading-relaxed mb-4">
                Â¡Terminamos el prototipo del brazo robÃ³tico impreso en 3D! ðŸ¤– Gran trabajo equipo. Si alguien de 4to aÃ±o quiere unirse al club, tenemos 2 cupos abiertos.
              </p>
        ...
        <div className="card p-5">
          <div className="flex gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="font-bold text-amber-400">Prof. JimÃ©nez</span>
                <span className="text-xs text-slate-500">hace 5h</span>
              </div>
              <p className="text-slate-300 text-sm leading-relaxed mb-4">
                Excelente debate hoy en clase sobre el cambio climÃ¡tico. Adjunto los apuntes generados por la IA en el repositorio de 5to A.
              </p>
              <div className="flex items-center gap-6">
