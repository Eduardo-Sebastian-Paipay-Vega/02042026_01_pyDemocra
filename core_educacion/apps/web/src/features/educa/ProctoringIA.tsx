...
const STUDENTS = [
  ...
  { id: 2, name: 'LucÃ­a P.', status: 'warning', flag: 'Mirada fuera de pantalla', thumbnail: 'L' },
  { id: 3, name: 'SofÃ­a T.', status: 'clean', flag: null, thumbnail: 'S' },
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Vigilancia automatizada anti-copia con anÃ¡lisis de biometrÃ­a y entorno.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div className="xl:col-span-3 card p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold text-white">Examen: CÃ¡lculo III - Final</h3>
        ...
        <div className="xl:col-span-1 space-y-6">
          ...
          <div className="bg-rose-950/20 border border-rose-500/20 rounded-2xl p-5">
            <h3 className="font-bold text-rose-500 flex items-center gap-2 mb-3">
              <AlertOctagon className="w-4 h-4" /> IntervenciÃ³n Requerida
            </h3>
            <p className="text-sm text-rose-200/80 mb-4">
              <strong>Diego A.</strong> - MÃºltiples rostros detectados en cÃ¡mara durante los Ãºltimos 15 segundos.
            </p>
            ...
            <div className="space-y-3 relative before:absolute before:inset-0 before:ml-2 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-800 before:to-transparent">
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                ...
                <div className="w-full p-3 bg-white/5 rounded-xl border border-border ml-3">
                  <div className="text-[10px] text-amber-400 font-bold mb-1">10:15 AM - LucÃ­a P.</div>
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                ...
                <div className="w-full p-3 bg-white/5 rounded-xl border border-border ml-3">
                  ...
                  <div className="text-xs text-slate-300">Reconocimiento facial biomÃ©trico completado. 18/20 verificados.</div>
                </div>
              </div>
