    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Mapa de calor emocional y termómetro de convivencia escolar.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 card p-6 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="font-bold text-white mb-2">Índice Global de Bienestar</h3>
        ...
        <div className="lg:col-span-3 card p-6">
          <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
            <AlertTriangle className="w-5 h-5 text-rose-500" /> Focos de Atención (Hotspots)
          </h3>
            ...
            <div className="bg-rose-500/5 border border-rose-500/20 rounded-2xl p-4 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-rose-300/80">3ero de Secundaria - Sección B (Semana de Parciales)</p>
                </div>
              </div>
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-4 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-300/80">4 alumnos reportan baja energía continua en Triage.</p>
                </div>
              </div>
        ...
        <div className="lg:col-span-4 card p-6">
          <h3 className="text-lg font-bold text-white mb-6">Mapa de Calor Institucional (Últimos 7 días)</h3>
