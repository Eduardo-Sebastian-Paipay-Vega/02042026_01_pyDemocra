...
import {
  ...
  DollarSign, ChevronRight, Download, RefreshCw, MoreHorizontal,
  Fingerprint, ShoppingBag, Bot, BarChart2, CheckCircle2,
  Clock, XCircle, ArrowUpRight, ArrowDownRight, Star, Trophy,
  Zap, Target,
  Globe, Eye, Database, Lock, Heart, Leaf, Map, Calendar,
  Award, GraduationCap, Landmark, Monitor, Thermometer,
  QrCode, MessageSquare,
} from 'lucide-react'
import {
  kpisDirector, retencionData, financieroYTD, riesgoDistribucion,
  docentes, marketplaceProducts, pasaporteData,
  analyticsCanales, logrosCompartidos, agentesIA, usuarios,
  deudores, ewsStudents, badges, leaderboard, misiones,
} from '../../lib/mock-data'
