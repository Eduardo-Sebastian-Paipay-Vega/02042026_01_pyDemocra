      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-white flex items-center gap-2">
            ...
            Adjudicación de Becas IA
          </h2>
          <p className="text-muted-foreground mt-1">
            Scoring algorítmico libre de sesgos (Académico + Socioeconómico).
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="card p-4">
            <h3 className="text-sm font-bold text-slate-400 mb-4 uppercase">Solicitudes en Revisión</h3>
            <div className="space-y-2">
              <div className="bg-white/10 border border-yellow-500/50 p-3 rounded-xl cursor-pointer">
                ...
                <div className="text-xs text-yellow-400 mt-1">Beca Excelencia (Renovación)</div>
              </div>
              <div className="bg-white/5 border border-border p-3 rounded-xl opacity-60">
                ...
                <div className="text-xs text-slate-500 mt-1">Beca Socioeconómica</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2">
          <div className="card p-8">
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                <div className="text-xs font-bold text-yellow-500 mb-1 tracking-wider uppercase">Análisis Algorítmico</div>
                <h3 className="text-2xl font-bold text-white">Candidato #4492 (Anónimo)</h3>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="bg-white/5 rounded-2xl p-4 border border-border text-center">
                ...
                <div className="text-[10px] text-slate-500 font-bold uppercase">Mérito Académico</div>
              </div>
              <div className="bg-white/5 rounded-2xl p-4 border border-border text-center">
                <Banknote className="w-6 h-6 text-rose-400 mx-auto mb-2" />
                <div className="text-xl font-bold text-white">85 pts</div>
                <div className="text-[10px] text-slate-500 font-bold uppercase">Necesidad Económica</div>
              </div>
              <div className="bg-white/5 rounded-2xl p-4 border border-border text-center">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/20 p-6 rounded-2xl flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-yellow-200/80 max-w-sm">
                  Basado en el histórico de adjudicaciones y políticas vigentes, el candidato cumple con el percentil superior. Se sugiere mantener el nivel de beca actual.
                </p>
              </div>
