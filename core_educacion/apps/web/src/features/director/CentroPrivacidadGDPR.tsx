      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Gestión de Cumplimiento GDPR/FERPA y registro de auditoría inmutable.
          </p>
        </div>
      </div>
            ...
            <div className="space-y-4">
              <button className="w-full bg-white/5 hover:bg-white/10 border border-border p-4 rounded-xl transition text-left group">
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  Eliminación segura y purga de registros de estudiantes retirados (GDPR Art. 17).
                </p>
              </button>
              ...
              <button className="w-full bg-white/5 hover:bg-white/10 border border-border p-4 rounded-xl transition text-left group">
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  Gestión de firmas digitales para FERPA y uso de datos de menores.
                </p>
              </button>
            </div>
          </div>
        ...
        <div className="lg:col-span-2">
          <div className="card p-6 h-full">
            ...
            <div className="space-y-3">
              {[
                { time: '12:45 PM', user: 'Director A.', action: 'Exportó reporte consolidado contable S1', level: 'high' },
                { time: '11:20 AM', user: 'Docente M.', action: 'Modificó calificación de Matemáticas', level: 'medium' },
                { time: '10:05 AM', user: 'Padre C.', action: 'Accedió a informe psicológico', level: 'low' },
                { time: '09:00 AM', user: 'Sistema', action: 'Purga GDPR ejecutada para ID #4592', level: 'high' },
                { time: 'Ayer', user: 'Docente P.', action: 'Visualizó perfil vocacional DTL', level: 'low' },
              ].map((log, i) => (
