    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-white flex items-center gap-2">
            ...
            Horarios Genéticos IA
          </h2>
          <p className="text-muted-foreground mt-1">
            Algoritmo evolutivo para asignación de cruces, espacios y horas docentes.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="card p-6">
          <h3 className="text-lg font-bold text-white mb-6">Parámetros del Algoritmo</h3>
          ...
          <div className="bg-rose-500/10 border border-rose-500/20 p-4 rounded-xl mb-6">
            ...
            <p className="text-xs text-rose-300/80 mt-1">El Prof. Jiménez cruza 3h de Física con 5to y 4to B.</p>
          </div>
        ...
        <div className="lg:col-span-2 card p-6 relative overflow-hidden flex flex-col justify-center">
          ...
          {progress > 0 ? (
            ...
            <div className="text-center text-slate-500">
              ...
              <p>El algoritmo genético está listo para iniciar simulación evolutiva.</p>
            </div>
          )}
