...
const rewards = [
  { id: 1, title: 'Día Libre (No Tareas)', cost: 5000, icon: <Zap className="w-6 h-6 text-yellow-500" /> },
  { id: 2, title: 'Merch del Colegio', cost: 15000, icon: <Gift className="w-6 h-6 text-pink-500" /> },
  { id: 3, title: 'Descuento 5% Pensión', cost: 50000, icon: <Gem className="w-6 h-6 text-purple-500" /> },
];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Gestión de la economía interna. Los XP de los estudiantes se respaldan en tokens institucionales.
          </p>
        </div>
        ...
        <div className="bg-[var(--s2)] rounded-2xl border border-border p-6 flex flex-col">
          ...
          <div className="mt-4 pt-4 border-t border-border">
            <p className="text-xs text-muted-foreground">
              Los tokens quemados (canjeados) son deducidos del liability financiero de la institución automáticamente.
            </p>
          </div>
        </div>
