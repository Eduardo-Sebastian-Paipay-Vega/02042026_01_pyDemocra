...
// RF-054: Banco de Ítemes Evaluativos LLM

export const BancoItemesLLM = () => {
  const [topic, setTopic] = useState('Estructura Celular');
  const [items, setItems] = useState([
    { id: 1, text: '¿Cuál es la función principal de la mitocondria?', type: 'Opción Múltiple', difficulty: 'Fácil', status: 'pending' },
    { id: 2, text: 'Explique cómo el proceso de ósmosis afecta a las células vegetales en soluciones hipertónicas.', type: 'Desarrollo', difficulty: 'Difícil', status: 'pending' },
    { id: 3, text: 'Identifique la estructura celular responsable de empaquetar proteínas.', type: 'Opción Múltiple', difficulty: 'Medio', status: 'pending' },
  ]);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-white flex items-center gap-2">
            ...
            Generador de Ítemes LLM
          </h2>
          <p className="text-muted-foreground mt-1">
            Prompting pedagógico. Genera, calibra y guarda preguntas con IA.
          </p>
        </div>
 ...
 ${activeItem.difficulty === 'Difícil' ? 'bg-rose-500/10 text-rose-400' : 
 ...
 'bg-emerald-500/10 text-emerald-400'}`}
            ...
            >
              ...
              <p className="text-xs mt-2 text-slate-600">Genera más ítemes o revisa el banco.</p>
