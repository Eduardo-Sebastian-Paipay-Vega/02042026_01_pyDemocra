...
// RF-044: QR Dinámico de Asistencia Criptográfica
...
export const AsistenciaQR = () => {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setTimeLeft(prev => {
        if (prev <= 1) {
          // Simulamos que un alumno más se registró tras el ciclo de QR
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-white flex items-center gap-2">
            ...
            Asistencia Criptográfica
          </h2>
          <p className="text-muted-foreground mt-1">
            Proyecta este código dinámico. Los estudiantes usarán su *Sovereign Wallet* para marcar asistencia.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 card p-8 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-2xl font-bold text-white mb-2">Física Avanzada - 10B</h3>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="card p-6">
              <div className="flex items-center gap-2 text-muted-foreground text-sm mb-2">
                <Clock className="w-4 h-4 text-yellow-500" /> Hora Límite
              </div>
              <div className="text-4xl font-bold text-white">
          ...
          <div className="card p-6 flex-1">
            ...
            <div className="mt-6 p-4 bg-orange-500/10 border border-orange-500/20 rounded-xl flex gap-3">
              ...
              <div className="text-sm text-orange-200">
                <span className="font-bold">Alerta Temprana (EWS):</span> Faltan 5 minutos para el límite y hay 3 alumnos con alto riesgo de inasistencia recurrente que aún no registran.
              </div>
            </div>
          </div>
