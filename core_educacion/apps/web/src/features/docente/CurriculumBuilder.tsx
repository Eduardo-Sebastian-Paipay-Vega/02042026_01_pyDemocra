...
const mockModules: Module[] = [
  {
    id: 'mod-1',
    title: 'Módulo 1: Introducción a la Materia',
    lessons: [
      { id: 'les-1', title: 'Bienvenida al curso', type: 'video', duration: '15 min' },
      { id: 'les-2', title: 'Lectura de Sílabo', type: 'document', duration: '10 min' },
    ]
  },
  {
    id: 'mod-2',
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Diseña la estructura de tu curso arrastrando y soltando módulos y lecciones. (RF-001)
          </p>
        </div>
          ...
          <div className="bg-card/30 backdrop-blur-md border border-border rounded-xl p-5 sticky top-6">
            ...
            <div className="space-y-3">
              <div className="p-3 border border-border rounded-lg bg-background/50 hover:bg-white/5 cursor-grab transition-colors flex items-center gap-3">
                ...
                <span className="text-sm font-medium">Video Lección</span>
              </div>
              <div className="p-3 border border-border rounded-lg bg-background/50 hover:bg-white/5 cursor-grab transition-colors flex items-center gap-3">
            ...
            <div className="mt-6 pt-6 border-t border-border">
              <div className="text-xs text-muted-foreground mb-2 uppercase font-bold tracking-wider">Estadísticas</div>
