...
const RESOURCES = [
  { id: 1, title: 'Simulador Dinámico de Gravedad', type: 'WebGL', author: 'Prof. García', impactScore: 9.2, downloads: 345, subjects: ['Física'], isVerified: true },
  { id: 2, title: 'Guía Definitiva de Ecuaciones Dif.', type: 'PDF', author: 'Prof. Torres', impactScore: 8.7, downloads: 1200, subjects: ['Matemáticas'], isVerified: true },
  ...
  { id: 4, title: 'Laboratorio Virtual: Titulación', type: 'Applet', author: 'Prof. Silva', impactScore: 9.8, downloads: 890, subjects: ['Química'], isVerified: true },
];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Materiales calificados por su impacto real en las notas de los alumnos (Algoritmo de Atribución).
          </p>
        </div>
