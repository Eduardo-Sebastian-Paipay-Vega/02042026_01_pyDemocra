...
// RF-065: Plan PIE/IEP (Programa de Inclusión Escolar)
          ...
          <div className="card p-4">
            ...
            <div className="space-y-2">
              <button className="w-full text-left bg-white/10 border border-teal-500/30 p-3 rounded-xl">
                ...
                <div className="text-xs text-teal-400 mt-1">Dislexia Fonológica</div>
              </button>
              <button className="w-full text-left bg-white/5 hover:bg-white/10 border border-border p-3 rounded-xl transition">
                <div className="font-bold text-sm text-slate-300">Lucía M.</div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="card p-8">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="text-2xl font-bold text-white mb-1">Mateo Rodríguez (3ero B)</h3>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="bg-white/5 p-4 rounded-2xl border border-border">
                <h4 className="text-xs text-slate-500 font-bold mb-2 uppercase">Adaptación Específica</h4>
                <p className="text-sm text-slate-300">Uso de tipografía OpenDyslexic en toda la plataforma. Tiempo extra (+30%) en evaluaciones.</p>
              </div>
              <div className="bg-white/5 p-4 rounded-2xl border border-border">
                <h4 className="text-xs text-slate-500 font-bold mb-2 uppercase">Apoyo Clínico</h4>
                <p className="text-sm text-slate-300">Terapia de lenguaje (Jueves 4:00 PM). Fonoaudiología.</p>
              </div>
            </div>

            {/* Ajustes Automáticos (Digital Twin) */}
            <div className="bg-indigo-500/10 border border-indigo-500/20 p-6 rounded-2xl">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3 text-sm text-indigo-200/80">
                  <CheckSquare className="w-4 h-4 text-indigo-400" /> Contraste de colores ajustado a modo "Alto Contraste Cálido".
                </li>
                <li className="flex items-center gap-3 text-sm text-indigo-200/80">
                  <CheckSquare className="w-4 h-4 text-indigo-400" /> Los exámenes adaptativos (CAT/IRT) bloquean ítems de alta carga léxica.
                </li>
              </ul>
            </div>
