      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            AnÃ¡lisis de micro-interacciones (mouse, scroll, pausas) correlacionadas con el engagement del curso.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="card p-5 rounded-2xl">
            ...
            <p className="text-xs text-muted-foreground">SeÃ±ales de frustraciÃ³n UI</p>
          </div>
          ...
          <div className="card p-5 rounded-2xl">
            ...
            <p className="text-xs text-muted-foreground">Puntos crÃ­ticos en evaluaciones</p>
          </div>
        </div>
          ...
          <div className="card p-6 h-full flex flex-col relative overflow-hidden">
            <div className="flex justify-between items-center mb-6 relative z-10">
              <h3 className="font-semibold text-lg text-white flex items-center gap-2">
                ...
                Matriz de CorrelaciÃ³n de Engagement
              </h3>
            ...
            <div className="flex-1 border border-dashed border-border rounded-xl relative flex items-center justify-center min-h-[300px]">
              ...
              <div className="relative z-10 text-center bg-black/50 p-6 rounded-2xl border border-border backdrop-blur-sm">
                <p className="text-slate-300 font-medium mb-2">SimulaciÃ³n de Motor de Interacciones</p>
                <p className="text-xs text-muted-foreground max-w-sm mx-auto">
                  En producciÃ³n, este panel dibuja heatmaps sobre las vistas de los estudiantes y cruza los eventos del mouse con las alertas del EWS.
                </p>
              </div>
