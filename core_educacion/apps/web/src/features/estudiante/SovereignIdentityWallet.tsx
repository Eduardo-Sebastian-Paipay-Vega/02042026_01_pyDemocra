...
const certificates = [
  { id: 'CERT-8X9A', name: 'Dominio en Lógica Booleana', date: 'Oct 2026', type: 'Hard Skill', verified: true },
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Tu identidad educativa descentralizada. Tú controlas quién ve tus credenciales.
          </p>
        </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-gradient-to-br from-orange-500/20 to-[var(--bg)] rounded-2xl border border-orange-500/30 p-6 relative overflow-hidden">
            ...
            <p className="text-sm text-slate-300 mb-6 relative z-10">
              Haz público tu perfil criptográfico a empresas e instituciones educativas de la red global.
            </p>
            ...
            <div className="flex items-center justify-between p-4 bg-black/40 rounded-xl border border-border relative z-10">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-sm">Perfil Público</span>
              </div>
          ...
          <div className="card-inner rounded-2xl border border-border p-6">
            <h3 className="font-semibold text-sm text-white mb-4 flex items-center gap-2">
              <Lock className="w-4 h-4 text-slate-400" /> Privacidad Criptográfica
            </h3>
            <p className="text-xs text-muted-foreground leading-relaxed">
              Educación OS utiliza Zero-Knowledge Proofs (ZK-SNARKs). Las instituciones pueden verificar que posees una habilidad sin revelar tu identidad o historial completo hasta que tú lo autorices.
            </p>
          </div>
        </div>
