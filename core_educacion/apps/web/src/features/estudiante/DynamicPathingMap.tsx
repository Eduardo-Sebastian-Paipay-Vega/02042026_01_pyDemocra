...
const pathNodes = [
  { id: 1, title: 'Conceptos Básicos', status: 'completed', x: 20, y: 50 },
  { id: 2, title: 'Lógica Fundamental', status: 'current', x: 40, y: 30 },
  { id: 3, title: 'Estructuras de Control', status: 'locked', x: 60, y: 50 },
  { id: 4, title: 'Ruta Alternativa: Matemáticas Discretas', status: 'suggested', x: 40, y: 70, isAI: true },
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Tu ruta de aprendizaje se reconfigura en tiempo real según tu dominio (RF-022).
          </p>
        </div>
