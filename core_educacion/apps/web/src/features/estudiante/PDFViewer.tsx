      ...
      <div className="bg-background/80 p-3 flex items-center justify-between border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs text-muted-foreground">Página 1 de 12</span>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-auto bg-black/20 p-8 flex justify-center relative">
        ...
        >
          ...
          <div className="border-b-2 border-slate-200 pb-6 mb-8">
            <h1 className="text-3xl font-bold text-slate-800 uppercase tracking-tight">Sílabo Oficial</h1>
            <p className="text-slate-500 font-medium mt-2">Semestre Académico 2026-I</p>
          </div>
          ...
          <div className="space-y-6">
            <section>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm bg-slate-50 p-4 rounded-lg">
                ...
                <p><strong>Código:</strong> EDU-401</p>
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed text-slate-700 text-justify">
                La asignatura tiene naturaleza teórico-práctica. Su propósito es brindar al estudiante las capacidades para diseñar, evaluar e implementar infraestructuras tecnológicas operacionales en instituciones de gran escala. Abarca temas como: Modelos HLS, motores adaptativos por IA, grafos de conocimiento y arquitecturas Zero Trust aplicadas a entornos de aprendizaje.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 text-sm space-y-2 text-slate-700">
                <li>Diseña arquitecturas monolíticas y distribuidas para entornos escolares.</li>
                <li>Implementa sistemas de Alerta Temprana (EWS) para predecir deserción.</li>
