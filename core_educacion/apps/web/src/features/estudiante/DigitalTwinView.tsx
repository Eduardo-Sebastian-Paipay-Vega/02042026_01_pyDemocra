...
const skillData = [
  { subject: 'Lógica Computacional', A: 85, fullMark: 100 },
  { subject: 'Matemáticas', A: 70, fullMark: 100 },
  { subject: 'Comunicación', A: 60, fullMark: 100 },
  { subject: 'Trabajo en Equipo', A: 90, fullMark: 100 },
  { subject: 'Pensamiento Crítico', A: 75, fullMark: 100 },
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Simulación holográfica de tu estado cognitivo y desarrollo de habilidades.
          </p>
        </div>
        <div className="px-4 py-2 bg-blue-500/10 text-blue-400 border border-blue-500/30 rounded-xl font-bold flex items-center gap-2 shadow-[0_0_15px_rgba(59,130,246,0.2)]">
          <Activity className="w-5 h-5 animate-pulse" /> Sincronización Biométrica: Activa
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="card-inner rounded-2xl border border-border p-6">
            <h3 className="font-semibold text-sm text-white mb-4 flex items-center gap-2">
              ...
              Proyección Vocacional Predictiva
            </h3>
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-xs mb-1">
                  <span className="text-slate-300">Ingeniería de Software</span>
