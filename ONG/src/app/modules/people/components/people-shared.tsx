...
export function PeopleTextInput(
...
export function PeopleSelectInput(
  props: SelectHTMLAttributes<HTMLSelectElement>
) {
  return (
    <select
      {...props}
      className="ong-field-control ong-native-select h-10 w-full rounded-xl px-3 text-[12px] outline-none"
      style={{
        border: "1px solid var(--t-border-strong)",
        background: "var(--t-input-bg)",
        color: "var(--t-text)",
...
export function PeopleTextArea(
  props: TextareaHTMLAttributes<HTMLTextAreaElement>
) {
  return (
    <textarea
      {...props}
      className="ong-field-control w-full rounded-xl px-3 py-2 text-[12px] outline-none"
      style={{
        border: "1px solid var(--t-border-strong)",
        background: "var(--t-input-bg)",
        color: "var(--t-text)",
