...
export function IdCardTemplateFormModal({
  ...
  // Scroll left panel to the active field card
  useEffect(() => {
  ...
  const handleFieldChange = useCallback(
    (fieldKey: IdCardFieldKey, changes: FieldChange) => {
      ...
      if (changes.posX !== undefined)
        setValue(`fields.${index}.posX`, changes.posX, { shouldDirty: true });
      if (changes.posY !== undefined)
        setValue(`fields.${index}.posY`, changes.posY, { shouldDirty: true });
      if (changes.width !== undefined)
        setValue(`fields.${index}.width`, changes.width, { shouldDirty: true });
      if (changes.height !== undefined)
        setValue(`fields.${index}.height`, changes.height, { shouldDirty: true });
    },
        ...
        <div className="grid gap-4 xl:grid-cols-[1.3fr_420px]">
          <div className="space-y-4">
            ...
            <PeopleSection
              ...
              description="Arrastra o redimensiona en el canvas de la derecha, o edita los valores directamente."
            >
          ...
          <div className="space-y-4">
            <PeopleSection
              title="Editor visual"
              description="Arrastra y redimensiona los campos directamente. Los cambios se sincronizan con el formulario izquierdo."
            >
              <div className="space-y-3">
