      ...
      <header className="relative z-20 border-b border-white/[0.06]">
        <div className="mx-auto flex h-[64px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/app/login"
              className="hidden sm:block text-[13px] text-[#A7A7A7] hover:text-white transition-colors cursor-pointer"
            >
              Log in
            </Link>
            <Link to="/app/login">
        ...
        {mobileMenuOpen && (
          <nav className="border-t border-white/[0.06] bg-[#0a0a0a]/95 backdrop-blur-xl px-4 py-4 md:hidden">
            ...
            <div className="mt-3 border-t border-white/[0.06] pt-3">
              <Link
                to="/app/login"
                className="block w-full rounded-2xl px-4 py-3 text-left text-[14px] text-[#A7A7A7] hover:text-white cursor-pointer"
              >
                Log in
              </Link>
            </div>
