...
export async function listCategorias(
  ...
  try {
    ...
    if (filters.type && filters.type !== "all") {
      query = query.eq("tipo", filters.type as "ingreso" | "egreso");
    }
