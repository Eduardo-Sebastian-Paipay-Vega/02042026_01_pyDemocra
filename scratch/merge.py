...
def merge():
    with open("scratch/old_onboarding.tsx", "r", encoding="utf-8") as f:
        old_code = f.read()
        
    with open("ong/src/app/pages/AdmissionOnboarding.tsx", "r", encoding="utf-8") as f:
        new_code = f.read()
...
"""
    ...
    with open("ong/src/app/pages/AdmissionOnboarding.tsx", "w", encoding="utf-8") as f:
        f.write(final_code)
