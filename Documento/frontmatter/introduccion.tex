...
investigaci\'on aplicada. El \autoref{chapter:problema} plantea el problema, la hip\'otesis, los
...
\autoref{chapter:metodo} expone el material y los m\'etodos: el tipo, nivel y dise\~no de la
investigaci\'on, la poblaci\'on y muestra, las variables e indicadores, y las t\'ecnicas e
instrumentos de recolecci\'on y an\'alisis. El \autoref{chapter:resultados_discusion} presenta y
discute los resultados —requisitos funcionales, cobertura de pruebas del \textit{backend} y de la API,
flujo del DDS, rendimiento, aislamiento \textit{multi-tenant}, usabilidad y seguridad—. Finalmente, el
\autoref{chapter:conclusiones} sintetiza las conclusiones y recomendaciones del estudio.
